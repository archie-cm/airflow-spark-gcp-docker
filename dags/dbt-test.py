...
with DAG(
    ...
    dbt_init_task = BashOperator(
        ...
        bash_command= "cd /usr/local/dbt/credit_card_dwh && dbt deps && dbt seed --profiles-dir ."
    )

    run_dbt_task = BashOperator(
        task_id="run_dbt_task",
        bash_command= "cd /usr/local/dbt/credit_card_dwh && dbt deps && dbt run --profiles-dir ."
    )
